...
class CupcakeViewsTestCase(TestCase):
    ...
    def test_patch_cupcake(self):
        with app.test_client() as client:
            ...
            for field in CUPCAKE_DATA_2:
                self.assertEqual(self.cupcake.serialize()[field], CUPCAKE_DATA_2[field])
    ...
    def test_404_cupcake(self):
        with app.test_client() as client:
            ...
            for method in possible_method:
                with self.subTest(f"Expected return: 404 for method {method}"):
